...
public class LogFileFilter implements Filter{
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		try {// 서브스트림(메인스트림), IOException이 날수있으니 try-catch로 묶음.
			writer = new PrintWriter(new FileWriter(filename, true)); // 기존 파일 끝에 새로운 내용 추가(append 모드,자바때 애국가 이어붙이는거 했음)
		} catch (IOException e) {
