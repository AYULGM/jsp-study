    ...
    <div class="row align-items-md-stretch">
    	<div class="row">
    		<table width="100%">
    			<tr>
    				<td align="left">
    					<a href="./deleteCart.jsp?cartId=<%= cartId %>" class="btn btn-danger">전부 삭제</a>
    				</td>
    				<td align="right">
...
/*     				for (int i = 0; i < cartList.size(); i++) {
    				Book freshBook = cartList.get(i);
    					int price =	cartList.get(i).getUnitPrice() * cartList.get(i).getQuantity();
    					sum += price; */
